...
module vpc {
  ...
  vpc_tags = merge(module.jcs-tags.jcs_aws_sss_prd_env_default_tags, map(
...
module app-subnets {
  ...
  jcs_account_tags                   = module.jcs-tags.jcs_aws_sss_prd_env_default_tags  
}
